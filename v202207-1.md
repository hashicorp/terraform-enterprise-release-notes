...
1. The version of the internally-managed Nomad server has been updated to to 1.3.1.
1. Container updates have been adopted, addressing reported vulnerabilities (CVEs) in underlying packages / dependencies.
